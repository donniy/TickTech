                ...
                <section>
                    <form v-on:submit.prevent="Register">
                        ...
                        <div class="form-group">
                            ...
                            <input v-on:keyup="checkIDAvailability" class="form-control" id="studentid" name="studentid" v-model="form.studentid" v-validate="'required|min:1|numeric'" type="text" placeholder="Student ID">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input v-on:keyup="checkEmailAvailability" id="email" class="form-control" name="email" v-model="form.email" v-validate="'required|min:1'" type="text" placeholder="Email address">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                class="form-control"
                                v-validate="'required'"
                                v-on:keyup="checkPswConfirmation"
